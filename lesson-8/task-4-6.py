...
class StoreMashines:
    ...
    def __init__(self, name, price, quantity, number_of_lists, *args):
        ...
        self.my_store_full = []
        self.my_store = []
        self.my_unit = {'Модель': self.name, 'Цена за шт.': self.price, 'Количество': self.quantity}
    ...
    def reception(self):
        try:
            ...
            unit_p = int(input(f'Введите цену за шт.: '))
...
unit_1 = Printer('Xerox', 1000, 10, 10)
unit_2 = Scanner('Canon', 2000, 20, 20)
unit_3 = Copier('hp', 3000, 30, 30)
